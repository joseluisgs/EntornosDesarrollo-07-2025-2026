namespace TestDobles.Test.Models;
...
public class PersonaTests
{
    ...
    public class CasosValidos
    {
        ...
        {
            // Arrange
            var persona = new Persona(0,"Juan", "juan@email.com", "Password1!", "12345678A", 25, 0);
        ...
        {
            // Arrange
            var persona = new Persona(0,"Juan", "juan@email.com", "Password1!", "12345678A", 25, 4);
        ...
        {
            // Arrange
            var persona = new Persona(0,"Juan", "juan@email.com", "Password1!", "12345678A", 25, 5);
        ...
        {
            // Arrange
            var persona = new Persona(0,"Juan", "juan@email.com", "Password1!", "12345678A", 25, 6);
        ...
        {
            // Arrange
            var persona = new Persona(0,"Juan", "juan@email.com", "Password1!", "12345678A", 25, 7);
        ...
        {
            // Arrange
            var persona = new Persona(0,"Juan", "juan@email.com", "Password1!", "12345678A", 25, 8);
        ...
        {
            // Arrange
            var persona = new Persona(0,"Juan", "juan@email.com", "Password1!", "12345678A", 25, 9);
        ...
        {
            // Arrange
            var persona = new Persona(0,"Juan", "juan@email.com", "Password1!", "12345678A", 25, 10);
        ...
        {
            // Arrange
            var persona = new Persona(0,"Juan", "juan@email.com", "Password1!", "12345678A", 25, calificacion);
    ...
    public class CasosInvalidos
    {
        ...
        public void CalificacionTexto_Negativa_ThrowsArgumentException()
        {
            ...
            // Act
            Action accion = () => { var x = persona.CalificacionTexto; };
