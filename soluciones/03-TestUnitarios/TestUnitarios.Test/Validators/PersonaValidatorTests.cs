...
using TestUnitarios.Validators;

namespace TestUnitarios.Test.Validators;
...
public class PersonaValidatorTests {
    ...
    public class CasosValidos {
        ...
        public void Validar_PersonaValida_SinErrores() {
            ...
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "00000000T", 25, 7.5);
        ...
        public void Validar_PersonaConEdadLimiteInferior_SinErrores() {
            ...
            var persona = new Persona("Ana", "ana@email.com", "Password1!", "00000001R", 1, 5.0);
        ...
        public void Validar_PersonaConEdadLimiteSuperior_SinErrores() {
            ...
            var persona = new Persona("Carlos", "carlos@email.com", "Password1!", "00000002W", 149, 8.0);
        ...
        public void Validar_PersonaConNombreLargo_SinErrores() {
            // Arrange - DNI válido
            var persona = new Persona("Juan Pérez García", "juan@email.com", "Password1!", "00000003A", 30, 6.5);
        ...
        public void Validar_PersonaConPasswordMaximaLongitud_SinErrores() {
            // Arrange - DNI válido
            var persona = new Persona("Juan", "juan@email.com", "Password12345678!", "00000004G", 25, 9.0);
        ...
        public void Validar_CalificacionCero_SinErrores() {
            // Arrange - DNI válido
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "00000005M", 25, 0);
        ...
        public void Validar_CalificacionDiez_SinErrores() {
            // Arrange - DNI válido
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "00000006Y", 25, 10);
        ...
        public void Validar_CalificacionDecimal_SinErrores() {
            // Arrange - DNI válido
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "00000007F", 25, 7.5);
    ...
    public class CasosInvalidos {
        ...
        public void Validar_NombreVacio_TieneError() {
            // Arrange
            var persona = new Persona("", "juan@email.com", "Password1!", "12345678A", 25, 5.0);
        ...
        public void Validar_NombreMuyCorto_TieneError() {
            // Arrange
            var persona = new Persona("J", "juan@email.com", "Password1!", "12345678A", 25, 5.0);
        ...
        public void Validar_EmailSinArroba_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juanemail.com", "Password1!", "12345678A", 25, 5.0);
        ...
        public void Validar_EmailSinPunto_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juan@emailcom", "Password1!", "12345678A", 25, 5.0);
        ...
        public void Validar_EmailVacio_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "", "Password1!", "12345678A", 25, 5.0);
        ...
        public void Validar_PasswordMuyCorto_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juan@email.com", "Pass1!", "12345678A", 25, 5.0);
        ...
        public void Validar_PasswordSinMayuscula_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juan@email.com", "password1!", "12345678A", 25, 5.0);
        ...
        public void Validar_PasswordSinNumero_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juan@email.com", "Password!", "12345678A", 25, 5.0);
        ...
        public void Validar_DNIVacio_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "", 25, 5.0);
        ...
        public void Validar_DNILongitudIncorrecta_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "1234567A", 25, 5.0);
        ...
        public void Validar_DNILetraIncorrecta_TieneError() {
            ...
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "99999999Z", 25, 5.0);
        ...
        public void Validar_DNIFormatoInvalido_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "ABCDEFGHI", 25, 5.0);
        ...
        public void Validar_EdadCero_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "12345678A", 0, 5.0);
        ...
        public void Validar_EdadNegativa_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "12345678A", -5, 5.0);
        ...
        public void Validar_EdadMayorQue150_TieneError() {
            // Arrange
            var persona = new Persona("Juan", "juan@email.com", "Password1!", "12345678A", 150, 5.0);
        ...
        public void Validar_PersonaConMultiplesErrores_TieneMultiplesErrores() {
            // Arrange
            var persona = new Persona("", "invalid", "abc", "X", -1, -5);
            ...
            // Assert
            errores.Should()
                .HaveCountGreaterThan(5)
                .And.Contain("El nombre no puede estar vacío")
                .And.Contain("El email debe contener '@'")
                .And.Contain("La contraseña debe tener al menos 8 caracteres")
                .And.Contain("El DNI debe tener 9 caracteres")
                .And.Contain("La edad debe ser mayor que 0")
                .And.Contain("La calificación no puede ser negativa");
        }
    }
}